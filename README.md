...
- 📖 **[Guía de Despliegue](docs/DEPLOYMENT.md)** - Instalación local y AWS EC2
- 🔄 **[Migración MySQL → PostgreSQL](docs/MIGRATION_MYSQL_TO_POSTGRESQL.md)** - Historial de cambios
...
│       ├── database/           # Modelos, migraciones, config
